                ...
                <table class="table table-striped table-hover">
                    ...
                    <c:forEach items="${adminListP}" var="o">
                        <tr>
                            ...
                            <td>${o.price}</td>
                            <td>
                                <a href="adminDetail?pid=${o.id}" target="_blank" class="edit" data-toggle="modal"><i class="material-icons" data-toggle="tooltip" title="Edit">&#xE254;</i></a>
                                <!--                                    <a href="#deleteEmployeeModal" class="delete" data-toggle="modal" ><i class="material-icons" data-toggle="tooltip" title="Delete">&#xE872;</i></a>-->
                                <form action = "delete">
                                    <input type ="hidden" name ="delid" value ="${o.id}"/>
                                    <input type ="submit" value="&#xE872;" onclick ="return confirm('Are you sure you want to delete product ${o.id}?')" class="material-icons" data-toggle="tooltip">
                                </form>
...
<!--                                        <li class="page-item active"><a href="productload?index=${i}" class="page-link">${i}</a></li>-->
                        <li class="page-item ${activeIndex==i?"active":""}"><a href="admincontrol?index=${i}" class="page-link">${i}</a></li>
                        </c:forEach>
