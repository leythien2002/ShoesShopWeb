                ...
                <div class="flexslider">
                    ...
                    <ul class="slides">
                        <li data-thumb="${detail.image1}">
                            <div class="thumb-image"><img src="${detail.image1}" data-imagezoom="true"
                                                          class="img-responsive"></div>
                        </li>
                        <li data-thumb="${detail.image2}">
                            <div class="thumb-image"><img src="${detail.image2}" data-imagezoom="true"
                                                          class="img-responsive"></div>
                        </li>
                        <li data-thumb="${detail.image3}">
                            <div class="thumb-image"><img src="${detail.image3}" data-imagezoom="true"
                                                          class="img-responsive"></div>
                        </li>
                    </ul>
                    <div class="clearfix"></div>
            ...
            <div id="horizontalTab">
                ...
                <div class="resp-tabs-container">
                    ...
                    <div class="tab2">
                        ...
                        <div class="single_page">
                            <c:forEach items="${lstReview}" var="o">

                                <div class="bootstrap-tab-text-grids">
                                    <div class="bootstrap-tab-text-grid">
                                        <ul>
                                            <lable> ${o.username}</lable>
                                        </ul>
                                        <p>${o.comment}</p>
                                        <div class="clearfix"></div>
                                    </div>
                    ...
                    <div class="tab3">
                        ...
                        <div class="single_page">
                            ...
                            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elPellentesque vehicula augue eget
                                nisl ullamcorper, molestie
                                blandit ipsum auctor. Mauris volutpat augue dolor.Consectetur adipisicing elit, sed do
                                eiusmod tempor incididunt
                                ut lab ore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation
                                ullamco. labore et dolore
                                magna aliqua.</p>
                            <p class="para">Lorem ipsum dolor sit amet, consectetur adipisicing elPellentesque vehicula
